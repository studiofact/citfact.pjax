...
class citfact_pjax extends CModule
{
    /**
     * @var string
     */
    public $MODULE_ID = 'citfact.pjax';
    ...
    {
        $this->MODULE_NAME = Loc::getMessage('PJAX_MODULE_NAME');
        $this->MODULE_DESCRIPTION = Loc::getMessage('PJAX_MODULE_DESCRIPTION');
    ...
    {
        $this->em->registerEventHandler('main', 'OnEndBufferContent', $this->MODULE_ID, 'Citfact\\Pjax\\PjaxEvent', 'endBufferContent');
    ...
    {
        $this->em->unRegisterEventHandler('main', 'OnEndBufferContent', $this->MODULE_ID, 'Citfact\\Pjax\\PjaxEvent', 'endBufferContent');
